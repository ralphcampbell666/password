...
else 
{
    ...
    if(is_admin)
    {
        ...
        {
            System.out.println("Exception in admin_safe_password_new.jsp=" + e);
        }  
    ...
    <body class="d-flex flex-column h-100">
                        ...
                        <div class="card-body">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item" aria-current="page"><a href="admin_safes.jsp"><i class="bi bi-gear-fill"></i>&nbsp;Safes</a></li>
                                    <li class="breadcrumb-item active" aria-current="page"><i class="bi bi-incognito"></i>&nbsp;Add Password</li>
                                </ol>
                            </nav>
                            <div class="card">
                                ...
                                <form action="admin_safe_password_new" name="in_form" method="POST" onsubmit="return check_form()">
                                    ...
                                    <div class="card-body">                                        
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                                                <label for="expires" class="form-label">Expires <small>(MM/dd/yyyy hh:mm:ss)</small></label>
                                                <div class="input-group">
                                                    <input id="expires" name="expires" class="form-control" type="text" value="">
                                                    <span class="input-group-text"><i class="bi bi-calendar-date "></i></span>
                                                </div>
                                            </div>
                                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                                                <label for="created" class="form-label">Created <small>(MM/dd/yyyy hh:mm:ss)</small></label>
                                                <div class="input-group">
                                                    <input id="created" name="created" class="form-control" type="text" value="">
                                                    <span class="input-group-text"><i class="bi bi-calendar-date "></i></span>
                                                </div>
                                            </div>
                                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
        ...
        <script>            
            function check_form()
            {
                ...
                {
                    alert("Name, Description, and Password must be filled out");
                    return false;
                }
            }
        </script>
