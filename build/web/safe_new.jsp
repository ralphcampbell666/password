...
else 
{
    ...
    if(is_admin || safe_creator)
    {
        ...
        {
            System.out.println("Exception in safe_new.jsp=" + e);
        }
%>
<!doctype html>
                    ...
                    <div class="card mx-auto">
                        <div class="card-body">
                            ...
                            <div class="card">
                                ...
                                <form action="safe_new" name="in_form" method="POST" onsubmit="return check_add_safe_form()">
                                    <div class="card-body">
                                        <div class="row mb-3">
                                                ...
                                                <table id="group_safe" class="table table-striped" style="width:100%">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th width="10%"><button type="button" class="btn btn-sm btn-link btn-info" data-bs-toggle="modal" data-bs-target="#permissions_modal"><small>Permission Info</small></button></th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        for(String group[]: groups)
                                                        {
                                                            ...
                                                            <td align="center"><input type="checkbox" class="form-check-input" id="group_id-<%=group[0]%>-create" name="group_id-<%=group[0]%>-create" value="create"></td>
                                                            <td align="center"><input type="checkbox" class="form-check-input" id="group_id-<%=group[0]%>-read" name="group_id-<%=group[0]%>-read" value="read"></td>
                                                            <td align="center"><input type="checkbox" class="form-check-input" id="group_id-<%=group[0]%>-update" name="group_id-<%=group[0]%>-update" value="update"></td>
                                                            <td align="center"><input type="checkbox" class="form-check-input" id="group_id-<%=group[0]%>-delete" name="group_id-<%=group[0]%>-delete" value="delete"></td>
                                                        </tr>
                                                            <%
                                                        }
                                                        %>
