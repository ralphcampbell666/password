...
else 
{
    ...
    if(is_admin)
    {
        ...
        {
            System.out.println("Exception in admin_group_edit.jsp=" + e);
        }  
        String group_id = request.getParameter("b");
        String group_info[] = db.group.by_id(con, group_id);
%>
<!doctype html>
                    ...
                    <div class="card mx-auto">
                        <div class="card-body">
                            ...
                            <div class="card">
                                ...
                                <form name="this_form" action="admin_group_edit" method="POST" onsubmit="return validateForm()">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-12">
                                                ...
                                                <select class="form-select form-control" id="user_ids" name="user_ids" multiple="multiple">                                                    
                                                    ...
                                                    ArrayList <String[]> users_in_group = db.user.all_users_in_group(con, group_id);
                                                    String selected = "";
                                                    for(String[] user: users)
                                                    {
                                                        ...
                                                        {
                                                            if(user[0].equalsIgnoreCase(user_in_group[0]))
                                                            {
                                                                selected = "selected";
                                                            }
                                                        }
                                                ...
                                                <table id="group_safe" class="table table-striped" style="width:100%">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        for(String safe[]: safes)
                                                        {
                                                            ...
                                                            <td><%=safe[3]%></td>
                                                            <td nowrap>                                                                
                                                                <a href="#" onclick="check_all(<%=safe[0]%>)"><smaller>Check&nbsp;All</smaller></a>&nbsp;/&nbsp;
                                                                <a href="#" onclick="uncheck_all(<%=safe[0]%>)"><smaller>None</smaller></a>
                                                            </td>
                                                            <%
                                                            String create_checked = "";
                                                            String read_checked = "";
                                                            String update_checked = "";
                                                            String delete_checked = "";
                                                            
                                                            ArrayList <String[]> safe_permissions  = db.safe.safe_permissions_for_group_id(con, safe[0], group_id);
                                                            for(String safe_permission[]: safe_permissions)
                                                            {
                                                                if(safe_permission[2].equalsIgnoreCase("1"))
                                                                {
                                                                    create_checked = "checked";
                                                                }
                                                                if(safe_permission[3].equalsIgnoreCase("1"))
                                                                {
                                                                    read_checked = "checked";
                                                                }
                                                                if(safe_permission[4].equalsIgnoreCase("1"))
                                                                {
                                                                    update_checked = "checked";
                                                                }
                                                                if(safe_permission[5].equalsIgnoreCase("1"))
                                                                {
                                                                    delete_checked = "checked";
                                                                }
                                                            }
                                                            %>
                                                            <td><input type="checkbox" <%=create_checked%> class="form-check-input" id="safe_id-<%=safe[0]%>-create" name="safe_id-<%=safe[0]%>-create" value="create"></td>
                                                            <td><input type="checkbox" <%=read_checked%> class="form-check-input" id="safe_id-<%=safe[0]%>-read" name="safe_id-<%=safe[0]%>-read" value="read"></td>
                                                            <td><input type="checkbox" <%=update_checked%> class="form-check-input" id="safe_id-<%=safe[0]%>-update" name="safe_id-<%=safe[0]%>-update" value="update"></td>
                                                            <td><input type="checkbox" <%=delete_checked%> class="form-check-input" id="safe_id-<%=safe[0]%>-delete" name="safe_id-<%=safe[0]%>-delete" value="delete"></td>
                                                        </tr>
                                                            <%
                                                        }
                                                        %>
