...
else 
{
    ...
    if(is_admin)
    {
        ...
        {
            System.out.println("Exception in admin_user_new.jsp=" + e);
        }  
                        ...
                        <div class="card-body">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item" aria-current="page"><a href="admin_users.jsp"><i class="bi bi-person"></i>&nbsp;Users</a></li>
                                    <li class="breadcrumb-item active" aria-current="page"><a href="#"><i class="bi bi-person-fill"></i>&nbsp;Add User</a></li>
                                </ol>
                            </nav>
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form name="this_form" action="admin_user_new" onsubmit="return validateForm()">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
                                                ...
                                                <br>
                                                <input type="checkbox" class="form-check-input" id="safe_creator" name="safe_creator">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
