 ...
 * @author ralph
 */
public class admin_group_new extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
    {
        ...
        try
        {
            ...
            int id = db.group.next_id(con);
            //get safe info
            //Name
            String name = request.getParameter("name");
            //Description
            String description = request.getParameter("description");
            PreparedStatement stmt = con.prepareStatement("INSERT INTO groups (id,name,description) VALUES (?,?,?)");
            stmt.setInt(1, id);
            stmt.setString(2, name);
            stmt.setString(3, description);
            stmt.execute();
            
            //get groups assigned to group
        ...
        {
            System.out.println("Exception in admin_group_new servlet=" + e);
        }
        String RedirectURL = "admin_groups.jsp?error=";
