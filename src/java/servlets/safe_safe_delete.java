 ...
 * @author ralph
 */
public class safe_safe_delete extends HttpServlet 
{

    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
    {
        String query = "";
        String RedirectURL = "safes.jsp";
        try
        {
        ...
        {
            System.out.println("Exception in safe_safe_delete servlet=" + e);
            RedirectURL = "safes.jsp?error=Something went wrong!";
        }
