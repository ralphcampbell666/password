...
else 
{
    ...
    if(is_admin)
    {
        ...
        {
            System.out.println("Exception in admin_safe.jsp=" + e);
        }
        String safe_id = request.getParameter("id");
        String safe_info[] = db.safe.safe_info(con, safe_id);
        String my_safe_permissions[] = db.safe.my_permissions_for_safe(con, safe_id, session_user_id);
%>
<!doctype html>
                        ...
                        <div class="card-body">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    {
                                        %>
                                        <a href="safe_new.jsp"><span class="badge bg-primary">Add a Safe</span></a>
                                        <%
                                    }
                                    %>
                                </ol>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    Safe <b><%=safe_info[2]%></b>
                                </div>
                                <form action="safe_edit" name="in_form" method="POST" onsubmit="return check_form()">
                                    <div class="card-body">
                                        <div class="row mb-3">
