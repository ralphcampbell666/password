...
else 
{
    ...
    if(is_admin)
    {
        ...
        {
            System.out.println("Exception in admin_password_undelete.jsp=" + e);
        }
                        ...
                        <div class="card-body">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><i class="bi bi-arrow-counterclockwise"></i>&nbsp;Undelete Password</li>
                                </ol>
                            </nav>
                            <div class="card">
                                <div class="card-header">
                                    All Deleted Passwords&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                </div>
                                <div class="card-body">
                                    <table id="table" class="table table-striped" style="width:100%">
                                        ...
                                        <tbody>
                                            <%                                                
                                            ArrayList <String[]> past_passwords = db.password.get_all_deleted_password_history(con, session);
                                            for(String[] password: past_passwords)
                                            {
                                                ...
                                                try
                                                {
                                                    ...
                                                    this_date_changed = default_picker_format.format(date);
                                                }
                                                catch(Exception e)
                                                {
                                                    this_date_changed = "";
                                                ...
                                                try
                                                {
                                                    ...
                                                    this_expires_on = default_picker_format.format(date);
                                                }
                                                catch(Exception e)
                                                {
                                                    this_expires_on = "";
                                                ...
                                                try
                                                {
                                                    ...
                                                    this_date_created = default_picker_format.format(date);
                                                }
                                                catch(Exception e)
                                                {
                                                    this_date_created = "";
                                            ...
                                            <tr>
                                                <td NOWRAP>
                                                    <a title="Undelete this Password?" href="admin_password_undelete?b=<%=this_id%>" onclick="return confirm('Are you sure you want to Undelete this item?');"><i style="cursor: pointer" class="bi bi-arrow-counterclockwise link-primary"></i></a>
                                                    &nbsp;<%=this_date_changed%>
                                                </td>
                                                <td><%=this_action%></td>
